...
"use strict";function sortJsonData(e){var t=e.sort(function(e,t){return e.age>t.age?1:e.age<t.age?-1:0});return t}function getAgeBase(e,t){var n,a=t[0].age,o=t[t.length-1].age;if(e>=a&&o>=e){var r=e.toString()[0];n=parseInt(r+0)}else a>e&&(n=parseInt(a)),e>o&&(n=parseInt(o));return n}function filterJsonData(e,t,n){var a=t.filter(function(t){return t.age==e&&t.gender.toLowerCase()==n.toLowerCase()});return a}function getRandomImage(e){for(var t=e.length-1,n=0,a=Math.floor(Math.random()*(t-n+1))+n;storedIndex===a;)a=Math.floor(Math.random()*(t-n+1))+n;storedIndex=a;var o=e[a];return o.gender+"/"+o.age+"/"+o.fileName}var $=require("./../bower_components/jquery/dist/jquery.js"),angular=require("angular"),personasApp=angular.module("personasApp",[]),personaPhotos=require("../Data/people.json"),defaultPersonaData={selectedDevices:{Desktop:!1,Laptop:!1,Tablet:!1,"Smart Phone":!1,"Office Phone":!1,Printer:!1,Fax:!1},maxCharacterCounts:{about:500,quote:150,questions:300},techUnderstanding:0,changeComfort:0},storedIndex;personasApp.controller("AppController",["$scope",function(e){e.className="",e.isViewing=!1,e.personaPhotos=personaPhotos,e.personaData=angular.copy(defaultPersonaData),e.personaFor="",e.toggleClass=function(t){e.className=""===e.className?t:""},e.resetPersona=function(){var t=e.personaData.questions;angular.copy(defaultPersonaData,e.personaData),e.personaData.questions=t},e.togglePersonaView=function(){e.isViewing=!e.isViewing},e.getRandomImage=function(){if(e.personaData.age&&e.personaData.gender){var t=sortJsonData(personaPhotos),n=getAgeBase(e.personaData.age,t),a=filterJsonData(n,t,e.personaData.gender);e.personaData.imageFile=getRandomImage(a)}},e.printPersona=function(){var t=document.title,n=e.personaData.name,a=t.indexOf("for");t=t.substring(0,-1!=a?a:t.length),n&&(document.title=t+" for "+n),window.print()}}]),personasApp.component("personaQuestion",{bindings:{ngModel:"=",defaultQuestionText:"@"},controller:["$element","$timeout",function(e,t){function n(){this.isEditing=!this.isEditing,this.isEditing?t(function(){e.children("input")[0].focus(),e.children("input")[0].setSelectionRange(0,e.children("input")[0].value.length)},0):0===this.ngModel.trim().length&&(this.ngModel=this.defaultQuestionText)}this.isEditing=!1,this.ngModel=this.defaultQuestionText,this.toggleEditing=n}],template:'\n        <label ng-click="$ctrl.toggleEditing()" for="" ng-if="!$ctrl.isEditing">{{$ctrl.ngModel}}</label>\n        <input type="text" class="text-field" ng-if="$ctrl.isEditing" ng-blur="$ctrl.toggleEditing()" ng-model="$ctrl.ngModel"/>\n    '});
