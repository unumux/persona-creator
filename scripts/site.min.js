...
"use strict";function sortJsonData(e){var n=e.sort(function(e,n){return e.age>n.age?1:e.age<n.age?-1:0});return n}function getAgeBase(e,n){var t,a=n[0].age,i=n[n.length-1].age;if(e>=a&&i>=e){var o=e.toString()[0];t=parseInt(o+0)}else a>e&&(t=parseInt(a)),e>i&&(t=parseInt(i));return t}function filterJsonData(e,n,t){var a=n.filter(function(n){return n.age==e&&n.gender.toLowerCase()==t.toLowerCase()});return a}function getRandomImage(e){var n=e.length-1,t=0,a=Math.floor(Math.random()*(n-t+1))+t;if(e.length>1)for(;storedIndex===a;)a=Math.floor(Math.random()*(n-t+1))+t;storedIndex=a;var i=e[a];return i.gender+"/"+i.age+"/"+i.fileName}var $=require("./../bower_components/jquery/dist/jquery.js"),angular=require("angular"),personasApp=angular.module("personasApp",[]),personaPhotos=require("../Data/people.json"),defaultPersonaData={selectedDevices:{Desktop:!1,Laptop:!1,Tablet:!1,"Smart Phone":!1,"Office Phone":!1,Printer:!1,Fax:!1},maxCharacterCounts:{about:500,quote:150,questions:300},techUnderstanding:50,changeComfort:50},storedIndex;personasApp.controller("AppController",["$scope",function(e){e.className="",e.isViewing=!1,e.personaPhotos=personaPhotos,e.personaData=angular.copy(defaultPersonaData),e.personaFor="",e.toggleClass=function(n){e.className=""===e.className?n:""},e.resetPersona=function(){var n=e.personaData.questions;angular.copy(defaultPersonaData,e.personaData),e.personaData.questions=n},e.togglePersonaView=function(){e.isViewing=!e.isViewing},e.getRandomImage=function(){if(e.personaData.age&&e.personaData.gender){var n=sortJsonData(personaPhotos),t=getAgeBase(e.personaData.age,n),a=filterJsonData(t,n,e.personaData.gender);e.personaData.imageFile=getRandomImage(a)}},e.printPersona=function(){var n=document.title,t=e.personaData.name,a=n.indexOf("for");n=n.substring(0,-1!=a?a:n.length),t&&(document.title=n+" for "+t),window.print()}}]),personasApp.component("personaQuestion",{bindings:{ngModel:"=",defaultQuestionText:"@"},controller:["$element","$timeout",function(e,n){function t(){this.isEditing=!this.isEditing,this.isEditing?n(function(){e.children("input")[0].focus(),e.children("input")[0].setSelectionRange(0,e.children("input")[0].value.length)},0):0===this.ngModel.trim().length&&(this.ngModel=this.defaultQuestionText)}this.isEditing=!1,this.ngModel=this.defaultQuestionText,this.toggleEditing=t}],template:'\n        <label ng-click="$ctrl.toggleEditing()" for="" ng-if="!$ctrl.isEditing">{{$ctrl.ngModel}}</label>\n        <input type="text" class="text-field" ng-if="$ctrl.isEditing" ng-blur="$ctrl.toggleEditing()" ng-model="$ctrl.ngModel"/>\n    '}),personasApp.component("sliderComponent",{bindings:{ngModel:"=",questionText:"@",minScaleDefinition:"@",maxScaleDefinition:"@",minSliderValue:"@",maxSliderValue:"@",showRangeValue:"@",rangeValueType:"@",rangeValueDisplayType:"@"},template:'\n		<p>{{$ctrl.questionText}}</p>\n		<div class="range-container" ng-class="$ctrl.rangeValueDisplayType">\n    	<input type="range"\n				class="progress-slider"\n				min="{{$ctrl.minSliderValue}}"\n				max="{{$ctrl.maxSliderValue}}"\n				ng-model="$ctrl.ngModel"\n			/>\n		<span class="range-value" ng-if="$ctrl.showRangeValue == \'true\'">{{ $ctrl.ngModel }}{{$ctrl.rangeValueType}}</span>\n        <div class="scale-definition" ng-if="$ctrl.minScaleDefinition || $ctrl.maxScaleDefinition">\n        	<span>{{$ctrl.minScaleDefinition}}</span>\n          <span>{{$ctrl.maxScaleDefinition}}</span>\n        </div>\n  	</div>\n'});
},{"../Data/people.json":1,"./../bower_components/jquery/dist/jquery.js":2,"angular":4}]},{},[5])
